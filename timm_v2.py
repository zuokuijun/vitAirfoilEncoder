...
class vit_models(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=30, embed_dim=768, depth=12,
...
if __name__ == '__main__':
    root = "../data/label_data/attention_val.txt"
    ...
    print(label)
    print(out_tensor[0])
    target_loss = loss(out_tensor[0], label)
